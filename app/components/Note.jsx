...
export default class Note extends React.Component {
	...
	renderEdit = () => {
		...
		// and then refer to the element in question later in the code through
		// `this.refs.input`. We could get the value of the input using 
		// `this.refs.input.value` through DOM in this case.
		//
		// Refs allow us to access the underlying DOM structure.
		// They can be using when you need to move beyond pure React. They also tie your implementation to the browser, though.
